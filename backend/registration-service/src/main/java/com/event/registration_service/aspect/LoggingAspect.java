package com.event.registration_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.event.registration_service.controller..*(..)) || execution(* com.event.registration_service.service..*(..))")
