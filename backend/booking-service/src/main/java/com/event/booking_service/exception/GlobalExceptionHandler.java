...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> handleEventNotFoundException(BookingNotFoundException ex){
        Map<String,String> errors = new HashMap<>();
    ...
    public ResponseEntity<Map<String,String>> handleInvalidBookingException(InvalidBookingDetailsException ex){
        Map<String,String> errors = new HashMap<>();
        errors.put("error", ex.getMessage());
        return new ResponseEntity<>(errors,HttpStatus.BAD_REQUEST);
    }
