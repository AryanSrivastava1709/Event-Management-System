package com.event.notification_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.event.notification_service.controller..*(..)) || execution(* com.event.notification_service.service..*(..))")
